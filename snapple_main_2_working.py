...
def reset_game():
    global snapple_x, snapple_y, eminem_x, eminem_y, powerup_x, powerup_y, cookie_x, cookie_y, snapple_speed, eminem_speed, speed_multiplier, health_points, eminem_health, game_over, lasers, eminem_respawn_timer, hit, shooting_effect, score, powerup_active
